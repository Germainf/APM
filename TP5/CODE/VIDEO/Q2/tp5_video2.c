...
extern void call_kernel(char * cuda_frame_in, int height, int width);
...
int main (int argc, char * argv[])
{
	...
	for(meta_cpt_frame = 0; meta_cpt_frame < limit && meta_cpt_frame < frame_count; meta_cpt_frame += nb_threads)
	{
